...
export default function FaqEntry({ question, answer }) {
  return (
    <details className="group [&_summary::-webkit-details-marker]:hidden">
      <summary className="flex cursor-pointer items-start justify-between gap-4 border border-neutral-200 rounded-xl bg-neutral-50 p-4">
        <h3 className="text-gray-900 font-normal text-xl sm:text-2xl tracking-tight">{question}</h3>
