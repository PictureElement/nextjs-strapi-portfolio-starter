  ...
  return (
    <>
      <figure className="flex justify-center mb-6">
        <svg width="48px" height="48px" enable-background="new 0 0 8 8" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex gap-3 self-center">
          {scrollSnaps.map((_, index) => (
            <DotButton
              ...
              className={'inline-block rounded-full border p-2 border-primary-100'.concat(
